...
public class TypeUtils {
    ...
    public static byte[] int2byteArray(int num) {
        byte[] b = new byte[4];
        b[0] = (byte) (num >>> 24);//取最高8位放到0下标
        b[1] = (byte) (num >>> 16);//取次高8为放到1下标
        b[2] = (byte) (num >>> 8); //取次低8位放到2下标
        b[3] = (byte) (num);       //取最低8位放到3下标
        return b;
    }
    ...
    public static byte[] short2byteArray(short num) {
        byte[] b = new byte[2];
        b[0] = (byte) (num >>> 8);//取最高8位放到0下标
        b[1] = (byte) (num);       //取最低8位放到1下标
        return b;
